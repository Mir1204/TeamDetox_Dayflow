              ...
              <div className="profile-content">
                ...
                <div className="profile-tabs">
                  <div className="profile-tab-buttons">
                    ...
                    <button className="profile-tab-btn">Salary Info</button>
          ...
          <div className="tab-content attendance-tab">
            <div className="attendance-header">
              <div className="attendance-view-toggle">
                <button 
                  className={`view-toggle-btn ${attendanceView === 'admin' ? 'active' : ''}`}
                  onClick={() => setAttendanceView('admin')}
                >
                  Attendance List View For Admin/HR Officer
                </button>
                <button 
                  className={`view-toggle-btn ${attendanceView === 'employee' ? 'active' : ''}`}
                  onClick={() => setAttendanceView('employee')}
                >
                  For Employees
                </button>
              </div>
              ...
              <div className="attendance-employee-view">
                <div className="employee-attendance-header">
                  <div className="date-range-controls">
                    ...
                    <div className="date-inputs">
                      ...
                      <input type="text" placeholder="Count of days present" className="count-input" />
                      <input type="text" placeholder="Leaves count" className="count-input" />
                      <input type="text" placeholder="Total working days" className="count-input" />
                    </div>
                    <button className="nav-btn">›</button>
                    <button className="nav-btn">››</button>
                  </div>
                ...
                <div className="attendance-notes">
                  <div className="note-section">
                    <h4>NOTE</h4>
                    <p>If the employee's working source is based on the assigned attendance</p>
                    <p>On the Attendance page, users should see day-wise attendance of employees by default for ongoing month, displaying details based on their working time, including breaks.</p>
                    <p>For Admin/Payroll officers: They can see attendance of all the employees present on the current day.</p>
                    <p>Attendance data serves as the basis for payroll generation.</p>
                    <p>The system should use the generated attendance records to determine the total number of payable days for each employee.</p>
                    <p>Any unpaid leave or missing attendance days should automatically reduce the number of payable days during payroll computation.</p>
                  </div>
                </div>
              </div>
            )}
