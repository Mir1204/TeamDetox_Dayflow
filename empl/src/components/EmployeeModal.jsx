...
const EmployeeModal = ({ isOpen, onClose, employee, isAdmin = false }) => {
...
// const EmployeeProfilePage = ({ employee, isAdmin }) => {
//   const [activeTab, setActiveTab] = useState('resume');
...
//           <h3>{employee.name}</h3>
//           <p className="job-title">{employee.position}</p>
